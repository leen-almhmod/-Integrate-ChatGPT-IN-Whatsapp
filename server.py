...
def get_last_message():
    ...
    print("PAGE.query_selector_all("")",PAGE.query_selector_all("div.markdown> p"));
    page_elements = PAGE.query_selector_all("div.markdown> p");
    
    last_element = page_elements[-1]
    #print("\n \n \n page_elements", last_element.inner_text());
